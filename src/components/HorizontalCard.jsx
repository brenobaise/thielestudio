...
function HorizontalCard({
    ...
    text = "no text" }) {
    return (
        <a href="#" className={`flex flex-col mt-20  ${reverse ? "flex-row-reverse" : "flex-row"}`}>
            <img src="/nobg-logo.png" className="w-50 object-contain" alt="Hair Treatment" />
            <div className="flex flex-col  p-6 lg:w-[800px]">
                <h5 className="mb-2 text-xl font-lobster text-center tracking-wider text-white lg:mb-4 lg:text-4xl">{title}</h5>
